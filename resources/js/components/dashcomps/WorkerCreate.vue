                ...
                <div class="mt-10 shadow-2xl bg-white rounded-3xl h-full p-10 w-full">
                    <div class="flex flex-col gap-4">
                        <div class="border-b-2">
                            ...
                            <input id="name" v-model="form.name" class="w-full" placeholder="ПІБ">
                        ...
                        <div class="flex flex-row gap-6 justify-between">
                            <div class="border-b-2 w-full">
                                ...
                                <div class="flex flex-row">
                                    <p>+380</p>
                                    <input type="number" id="phone_number" v-model="form.phone_number" class="ml-2 w-full"
                            ...
                            <div class="border-b-2 w-full">
                                <label for="phone_number" class="font-sofia font-bold text-2xl">Зарплата</label>
                                <div class="flex flex-row">
                                    <input @input="updateSalary()" type="number" id="phone_number" v-model="firstsalary"
                                        class="ml-2 w-full" placeholder="12 300">
                                    <p>грн.</p>
                        ...
                        <div class="border-b-2">
                            ...
                            <input id="mail" v-model="form.mail" class="w-full" placeholder="Електронна пошта">
                        ...
                        <div class="flex flex-row gap-6 justify-between border-b-2">
                            <div class="w-full">
                                <label for="post" class="font-sofia font-bold text-2xl">Посада</label>
                                <select id="post" v-model="form.post"
                        ...
                        <div class="flex flex-row border-b-2">
                            <div>
                                ...
                                <input id="password" v-model="form.password" class="w-full"
                            ...
                            <button
                                class="fastbutton bg-neutral-700 text-white justify-center align-baseline items-center flex p-2 rounded-2xl m-2">Згенерувати</button>
                        </div>
                    </div>
