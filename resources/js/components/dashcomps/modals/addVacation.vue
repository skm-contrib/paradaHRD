            ...
            <form @submit.prevent="addVacationPop()">
                <div class="flex flex-col  justify-center gap-4">
                    <div class="flex justify-center gap-4 flex-col">
                        <p class="font-sofia flex font-bold justify-center text-2xl">Оберіть проміжок дат</p>
                        <div class="flex flex-row  justify-center">
                            <VueDatePicker v-model="newSal" day-picker range :enable-time-picker="false">
                            </VueDatePicker>
                        </div>
                    </div>
...
export default {
    ...
    {
        addVacationPop() {
            this.addVacation(this.newSal, this.id);
            this.toggleFunc()
        },
    }
}
