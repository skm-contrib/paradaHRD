        ...
        <div class="flex flex-col justify-center gap-4">
          <div class="flex justify-center gap-4 flex-col">
            ...
            <div class="flex flex-row justify-center">
              <input
                type="text"
                class="font-bold text-green-800 text-xl bg-transparent w-fit placeholder-neutral-600 mr-2"
                v-model="newSal.salvalue"
                placeholder="Сума коштів"
              />
              <p class="font-bold text-xl">грн.</p>
            </div>
            <p class="font-sofia flex font-bold justify-center text-2xl">
              Оберіть дату
            </p>
...
export default {
  ...
  methods: {
    addSalaryPop() {
      this.newSal.salvalue = Math.abs(this.newSal.salvalue);
